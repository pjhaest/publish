...
/* Modified by Anna Logg <anna@loggsystems.se>, 2008.
 * Minor formatting fixes, and added build instructions (see below).
 */
...
/* This extension is most easily built using distutils.
   Instructions may be found at

   http://www.python.org/doc/2.5.2/ext/building.html#building

   This requires the header file Python.h, which (on Debian/Ubuntu)
   is provided by the package python-dev.
*/
